...
export const STRINGS = {
  en: {
    ...
    gatewayPhoneTitle: "I don't use websites",
    gatewayPhoneDesc: "Call YojnaSathi from your phone",
    gatewayPhoneCta: "Call YojnaSathi",
    gatewayPhoneNote: "Phone support will be available soon.",
  ...
  hi: {
    ...
    gatewayPhoneTitle: "मैं वेबसाइट का उपयोग नहीं करता/करती",
    gatewayPhoneDesc: "फ़ोन से योजनासाथी से संपर्क करें",
    gatewayPhoneCta: "योजनासाथी को कॉल करें",
    gatewayPhoneNote: "फ़ोन समर्थन जल्द ही उपलब्ध होगा।",
  ...
  mr: {
    ...
    gatewayPhoneTitle: "मी संकेतस्थळ वापरत नाही",
    gatewayPhoneDesc: "फोनवर योजनासाथीशी संपर्क साधा",
    gatewayPhoneCta: "योजनासाथीला कॉल करा",
    gatewayPhoneNote: "फोन समर्थन लवकरच उपलब्ध होईल.",
