...
export const STRINGS = {
  en: {
    ...
    viewNearbyCenters: "📍 View Nearby Centers",
    hideNearbyCenters: "📍 Hide Nearby Centers",
    applyOfflineLabel: "Apply Offline",
    schemeDataInfoMissing: "Application details are not available in the current scheme data.",
    whereToApplyTitle: "Nearby Application Centers",
    noLocationsFound: "No physical application centers registered for this scheme in your selected jurisdiction. You can apply online via the official portal.",
    loadingApplicationCenters: "Loading application centers near you...",
    applicationCentersError: "We couldn't load application centers right now. You can still apply online via the official portal.",
    officeOfficialSource: "Official Portal",
    officeTypeCSC: "CSC / Maha e-Seva",
    officeTypeGov: "Government Office",
    officeTypeTahsil: "Tahsil Office",
    officeTypeCollectorate: "Collectorate",
    officeTypeAgri: "District Agriculture Office",
    officeTypeHospital: "Civil Hospital",
    officeTypeAnganwadi: "Anganwadi Center",
    officeTypeCommissionerate: "State Commissionerate",
    officeTypeDistrict: "District Office",
    centerVisitAssistance: "Assisted Application & Form Filling",
    pinCodeLabel: "PIN",
    viewAllCenters: "View all {count} centers ↓",
    showFewerCenters: "Show fewer centers ↑",
  ...
  hi: {
    ...
    viewNearbyCenters: "📍 नजदीकी केंद्र देखें",
    hideNearbyCenters: "📍 केंद्र छिपाएं",
    applyOfflineLabel: "ऑफलाइन आवेदन",
    schemeDataInfoMissing: "मौजूदा डेटा में इस योजना के आवेदन विवरण उपलब्ध नहीं हैं।",
    whereToApplyTitle: "निकटतम आवेदन केंद्र",
    noLocationsFound: "चयनित क्षेत्र में इस योजना के लिए कोई विशिष्ट भौतिक केंद्र पंजीकृत नहीं है। आप आधिकारिक पोर्टल पर ऑनलाइन आवेदन कर सकते हैं।",
    loadingApplicationCenters: "आपके आस-पास के आवेदन केंद्र लोड हो रहे हैं...",
    applicationCentersError: "अभी आवेदन केंद्र लोड नहीं हो सके। आप आधिकारिक पोर्टल पर ऑनलाइन आवेदन कर सकते हैं।",
    officeOfficialSource: "आधिकारिक पोर्टल",
    officeTypeCSC: "सीएससी / महा ई-सेवा",
    officeTypeGov: "सरकारी कार्यालय",
    officeTypeTahsil: "तहसील कार्यालय",
    officeTypeCollectorate: "ज़िलाधिकारी कार्यालय",
    officeTypeAgri: "ज़िला कृषि कार्यालय",
    officeTypeHospital: "नागरिक अस्पताल",
    officeTypeAnganwadi: "आंगनवाड़ी केंद्र",
    officeTypeCommissionerate: "राज्य आयुक्तालय",
    officeTypeDistrict: "ज़िला कार्यालय",
    centerVisitAssistance: "सहायता प्राप्त आवेदन एवं फॉर्म भरना",
    pinCodeLabel: "पिन",
    viewAllCenters: "सभी {count} केंद्र देखें ↓",
    showFewerCenters: "कम केंद्र देखें ↑",
  ...
  mr: {
    ...
    viewNearbyCenters: "📍 जवळची अर्ज केंद्रे पहा",
    hideNearbyCenters: "📍 केंद्रे लपवा",
    applyOfflineLabel: "ऑफलाइन अर्ज",
    schemeDataInfoMissing: "सध्याच्या डेटामध्ये या योजनेच्या अर्जाची माहिती उपलब्ध नाही.",
    whereToApplyTitle: "जवळचे अर्ज केंद्र",
    noLocationsFound: "निवडलेल्या क्षेत्रात या योजनेसाठी कोणतेही विशिष्ट प्रत्यक्ष अर्ज केंद्र नोंदणीकृत नाही. तुम्ही अधिकृत पोर्टलद्वारे ऑनलाइन अर्ज करू शकता.",
    loadingApplicationCenters: "तुमच्या जवळील अर्ज केंद्रे लोड होत आहेत...",
    applicationCentersError: "आत्ता अर्ज केंद्रे लोड होऊ शकली नाहीत. तुम्ही अधिकृत पोर्टलवर ऑनलाइन अर्ज करू शकता.",
    officeOfficialSource: "अधिकृत पोर्टल",
    officeTypeCSC: "सीएससी / महा ई-सेवा केंद्र",
    officeTypeGov: "शासकीय कार्यालय",
    officeTypeTahsil: "तहसील कार्यालय",
    officeTypeCollectorate: "जिल्हाधिकारी कार्यालय",
    officeTypeAgri: "जिल्हा कृषी कार्यालय",
    officeTypeHospital: "जिल्हा रुग्णालय",
    officeTypeAnganwadi: "अंगणवाडी केंद्र",
    officeTypeCommissionerate: "राज्य आयुक्तालय",
    officeTypeDistrict: "जिल्हा कार्यालय",
    centerVisitAssistance: "ऑनलाइन अर्ज व फॉर्म भरण्यासाठी सहाय्य",
    pinCodeLabel: "पिन",
    viewAllCenters: "सर्व {count} केंद्रे पहा ↓",
    showFewerCenters: "कमी केंद्रे दाखवा ↑",
